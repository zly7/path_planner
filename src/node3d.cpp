...
const float Node3D::resolution_mutiplier = sqrt(Constants::positionResolution);
// R = 6, 6.75 DEG
...
const float Node3D::dt[] = { 0* Node3D::resolution_mutiplier, 0.1178097* Node3D::resolution_mutiplier,   -0.1178097* Node3D::resolution_mutiplier};
